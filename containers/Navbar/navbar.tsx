    ...
    <div className="navbar  mb-2">
      <div className="navbar-left">
        ...
        <div className="routes">
          <ul
            className={click ? "nav-menu active slide-in" : "nav-list"}
            id="slider"
          >
            <li
              className={
                StoredPathname === "/portfolio" ? "nav-list-active" : ""
              }
              onClick={() => onScreenRoute("/portfolio")}
            >
              Portfolio
            </li>
            <li
              className={StoredPathname === "/sena" ? "nav-list-active" : ""}
              onClick={() => onScreenRoute("/sena")}
            >
              sENA
            </li>
            <li
              className={
                StoredPathname === "/" || StoredPathname === "/buy"
                  ? "nav-list-active"
                  : ""
              }
            ...
            <li
              className={
                StoredPathname === "/dashboard" ? "nav-list-active" : ""
              }
              onClick={() => onScreenRoute("/dashboard")}
            >
              Dashboards
            </li>
          </ul>
